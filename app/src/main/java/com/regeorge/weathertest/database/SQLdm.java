package com.regeorge.weathertest.database;
...
public class SQLdm {
	...
	//数据库存储路径
	String filePath = "data/data/com.regeorge.weathertest/databases/test.db";
	//数据库存放的文件夹
	String pathStr = "data/data/com.regeorge.weathertest/databases";
